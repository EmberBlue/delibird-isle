...
#define OBJ_EVENT_GFX_CACNEA                     242
#define OBJ_EVENT_GFX_AGATHA                     243
#define OBJ_EVENT_GFX_DELIBIRD                   244
...
#define OBJ_EVENT_PAL_TAG_DELIBIRD                0x1125  // (Or just use the next available number)
