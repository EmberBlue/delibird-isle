...
enum {
    ...
    HEAL_LOCATION_TEST_TOWN_2,
    HEAL_LOCATION_TEST_DESERT_ROUTE,
    HEAL_LOCATION_PARCEL_ISLE,
    HEAL_LOCATION_PARCEL_DELIBIRD,
    HEAL_LOCATION_PARCEL_COAST,
    HEAL_LOCATION_PARCEL_WEATHER,
    NUM_HEAL_LOCATIONS
};
