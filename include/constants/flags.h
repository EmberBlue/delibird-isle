...
#define FLAG_SKALD_ITEM_HL_SURF             0x68  // Skaldmere: §08 Ch4 Highlands surf-islet cache
...
#define FLAG_SKALD_ITEM_HL_FALLS            0xE9 // Skaldmere: §08 Ch4 Highlands waterfall-crest cache
...
#define FLAG_VISITED_TEST_TOWN                      (SYSTEM_FLAGS + 0x21) 
#define FLAG_VISITED_ROGUE_SPECIAL_MEWTWO           (SYSTEM_FLAGS + 0x22) 
#define FLAG_VISITED_PARCEL_ISLE                    (SYSTEM_FLAGS + 0x23) 
