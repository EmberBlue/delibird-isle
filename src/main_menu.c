    ...
    if (!gPaletteFade.active)
    {
        ...
        switch (action)
        {
            ...
            default:
                ...
                // INTERIM (Skaldmere): skip the Hoenn Birch intro and drop
                // straight into the overworld arrival town. The §07 prologue
                // (ferry/letter, gender select) replaces this later.
