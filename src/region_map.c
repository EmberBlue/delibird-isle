...
{
    // --- Skaldmere fly anchors. Mainland zones land at the harbour (the
    // Corps flies you home); the islands land at their ferry moorings.
    ...
    [MAPSEC_SKALD_MISTWOOD] = {MAP_GROUP(MAP_PARCEL_ISLE), MAP_NUM(MAP_PARCEL_ISLE), HEAL_LOCATION_PARCEL_ISLE},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_TEST_TOWN:
        return FlagGet(FLAG_VISITED_TEST_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_ROGUE_SPECIAL_MEWTWO:
        return FlagGet(FLAG_VISITED_ROGUE_SPECIAL_MEWTWO) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_PARCEL_ISLE:
        return FlagGet(FLAG_VISITED_PARCEL_ISLE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    default:
