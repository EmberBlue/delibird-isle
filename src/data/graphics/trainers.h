...
const u16 gTrainerPalette_Alola_Acerola[]  = INCBIN_U16("graphics/trainers/front_pics/alola/acerola.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_ALOLA_ACEROLA, gTrainerFrontPic_Alola_Acerola, gTrainerPalette_Alola_Acerola),
};
